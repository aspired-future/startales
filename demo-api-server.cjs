...
function generateMemeImagePrompt(content) {
  ...
  const memePrompts = [
    "A funny space meme with text overlay showing a confused astronaut",
    "A galactic social media meme with alien characters looking confused",
    "A space station meme with floating objects and funny expressions",
    "A cosmic meme showing planets with funny faces and expressions",
    "A zero-gravity meme with floating food and surprised characters",
    "A space travel meme with rocket ships and humorous situations",
    "A alien pet meme with cute space creatures causing chaos",
    "A space coffee meme with floating liquid and tired astronauts"
  ];
