...
// Import demo modules
const { setupGameStateAPIs } = require('./apis/game-state-apis');
const { setupDemographicsAPIs } = require('./apis/demographics-apis');
const { setupMigrationAPIs } = require('./apis/migration-apis');
const { setupCitiesAPIs } = require('./apis/cities-apis');
const { setupWitterAPIs } = require('./apis/witter-apis');
const { setupOtherAPIs } = require('./apis/other-apis');

// Import demo pages
const { setupDemoPages } = require('./pages/demo-pages');
