  ...
  const generateMockAssets = (): VisualAsset[] => [
    {
      ...
      prompt: 'Futuristic military leader with cybernetic enhancements, commanding presence',
    ...
    },
    {
      ...
      prompt: 'Alien planet surface with crystalline formations and purple atmosphere',
    ...
    },
    {
      ...
      prompt: 'Diplomatic meeting between human and alien representatives',
