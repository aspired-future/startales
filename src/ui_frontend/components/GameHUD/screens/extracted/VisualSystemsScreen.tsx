  ...
  const generateMockAssets = (): VisualAsset[] => [
    {
      ...
      prompt: 'photorealistic sci-fi concept art, highly detailed, professional game asset, portrait of Admiral Zara, human features, diverse ethnicities, advanced cybernetic enhancements, military attire, blue and silver tones, clean metallic surfaces, holographic displays, heroic expression and pose, interstellar era technology and clothing, dramatic cinematic lighting with volumetric fog and particle effects, dynamic composition with depth of field and atmospheric perspective, 8K resolution, ultra-high quality, sharp focus, intricate details, modern sci-fi aesthetic, sleek futuristic design, advanced technology',
    ...
    },
    {
      ...
      prompt: 'photorealistic sci-fi concept art, highly detailed, professional game asset, Kepler-442b Surface, alien planet surface with unique geological features, atmospheric effects, mysterious atmosphere, interstellar era structures and technology, alien flora and fauna, atmospheric effects and weather patterns, crystalline formations and purple atmosphere, dramatic cinematic lighting with volumetric fog and particle effects, dynamic composition with depth of field and atmospheric perspective, 8K resolution, ultra-high quality, sharp focus, intricate details, modern sci-fi aesthetic, sleek futuristic design, advanced technology',
    ...
    },
    {
      ...
      prompt: 'photorealistic sci-fi concept art, highly detailed, professional game asset, cinematic sequence: First Contact Sequence, deep space background with distant stars, nebulae, and cosmic phenomena, interstellar era technology and effects, dramatic pacing and tension, dynamic camera movements, particle effects and energy signatures, character interactions and dialogue, ambient sound design elements, diplomatic meeting between human and alien representatives, dramatic cinematic lighting with volumetric fog and particle effects, dynamic composition with depth of field and atmospheric perspective, 8K resolution, ultra-high quality, sharp focus, intricate details, modern sci-fi aesthetic, sleek futuristic design, advanced technology, 30 second duration, smooth transitions',
