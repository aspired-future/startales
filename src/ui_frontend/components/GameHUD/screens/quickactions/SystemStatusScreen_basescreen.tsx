...
export const SystemStatusScreen: React.FC<ScreenProps> = ({
  screenId,
  title,
  icon,
  gameContext
  ...
  const apiEndpoints: APIEndpoint[] = [
    ...
    { method: 'GET', path: '/api/system-performance', description: 'Get performance metrics' },
    { method: 'GET', path: '/api/system-alerts', description: 'Get system alerts' },
    { method: 'GET', path: '/api/system-logs', description: 'Get system logs' }
  ];
        ...
        <div className="standard-dashboard">
          {!loading && !error && systemData ? (
            ...
            <div style={{ 
              ...
              {loading ? 'Loading system status data...' : 
               error ? `Error: ${error}` : 
