...
function generateMemeImagePrompt(content) {
  const memePrompts = [
    "A mystical cosmic meme showing sentient planets with glowing crystal faces and magical expressions",
    "Ethereal space creatures floating in zero gravity with energy auras and humorous captions",
    "Mystical aliens doing everyday activities with crystal-tech magic in a fantastical way",
    "Magical starcraft with energy eyes and silly mystical expressions",
    "Enchanted galactic food items with energy arms and legs being dramatically cosmic",
    "Crystal space citadels shaped like magical everyday objects with energy glow",
    "Space-mystics in ridiculous situations with funny energy text overlays",
    "Sentient planets arguing with each other in cosmic comic strip format with magical speech bubbles"
  ];
  ...
  const relevantWord = contentWords[Math.floor(Math.random() * contentWords.length)] || 'cosmic magic';
    ...
    const prompts = [
      {
        ...
        prompt: `Create an official mystical government announcement about cosmic policy, crystal-tech infrastructure, or interdimensional public services. Make it sound professional but include fantastical bureaucratic details. Character: ${character.name} from ${character.civilization} crystal council government. Include specific energy-data and cosmic timelines.`,
        examples: [
...
// Comprehensive Demo Hub (removed /demo/hud route)
