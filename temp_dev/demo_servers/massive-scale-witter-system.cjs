...
async function generateAIContent(character, contentType, gameContext) {
  const contentPrompts = {
    random_life: [
      {
        prompt: `Generate a funny social media post about an absurd everyday situation in a mystical galactic civilization. Character: ${character.name}, a ${character.personality} ${character.profession} from the crystal cities of ${character.civilization}. Make it genuinely witty and relatable but with magical space fantasy elements like energy crystals, floating platforms, and cosmic magic. Include emojis and hashtags naturally.`,
        style: 'absurd_crystal_tech_fails'
      },
      {
        prompt: `Create a humorous post about dating or relationships in a space fantasy setting. Character: ${character.name} (${character.personality}) from the ethereal realm of ${character.planet}. Make it embarrassing but endearing with specific galactic fantasy details like energy-bonding ceremonies, crystal compatibility, and cosmic consciousness connections.`,
        style: 'cosmic_dating_disasters'
      },
      {
        prompt: `Write about magical pet or enchanted food-related chaos in a mystical galactic society. Character: ${character.name}, ${character.profession} from the star system ${character.starSystem}. Focus on unexpected consequences of crystal-tech magic and energy-based cuisine.`,
        style: 'mystical_daily_chaos'
      }
    ],
    
    citizen_commentary: [
      {
        prompt: `Generate a witty citizen comment about mystical galactic politics or recent cosmic events. Character: ${character.name} from the crystal realm of ${character.civilization}. Make it critical but not mean-spirited, with specific references to interdimensional galactic affairs and energy-council decisions. Show frustration with cosmic political systems.`,
        style: 'cosmic_political_snark'
      },
      {
        prompt: `Create a post expressing economic anxiety or working-class concerns in a magical galactic context. Character: ${character.name}, ${character.profession} from the energy-world ${character.planet}. Make it relatable to modern economic issues but with crystal-tech and energy-economy elements.`,
        style: 'crystal_economic_anxiety'
      },
      {
        prompt: `Write about media criticism or diplomatic embarrassment in mystical galactic society. Character: ${character.name} (${character.personality}) commenting on interdimensional relations or cosmic news coverage through energy-broadcasts.`,
        style: 'cosmic_media_criticism'
      }
    ],
    
    expert_government: [
      {
        prompt: `Create an official mystical government announcement or cosmic policy update. Character: ${character.name} from the crystal council of ${character.civilization}. Include specific energy-data, cosmic timelines, and ethereal bureaucratic language. Make it professional but fantastical with references to crystal-tech governance.`,
        style: 'cosmic_official_announcement'
      },
      {
        prompt: `Generate a research or expert analysis post about mystical scientific breakthroughs. Character: ${character.name}, ${character.profession} from the energy-laboratories of ${character.starSystem}. Include crystal-tech details and cosmic professional language about magical discoveries.`,
        style: 'mystical_research_update'
      },
      {
        prompt: `Write a security briefing or regulatory notice for galactic fantasy civilization. Character: ${character.name} from ${character.civilization} cosmic authorities. Make it authoritative with specific operational details about energy-shields, crystal-tech security, and interdimensional protocols.`,
        style: 'cosmic_security_briefing'
      }
    ]
  };
